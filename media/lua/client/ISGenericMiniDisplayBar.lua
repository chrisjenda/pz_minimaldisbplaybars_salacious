...
function ISGenericMiniDisplayBar:render(...)
    ...
    if self.imageShowBack then
        ...
        local switchMoodle =
        {
            ...
            ["drunkenness"] = function()
                self.texBG = self:getImageBG(self.isoPlayer, MoodleType.ToIndex(MoodleType.FromString( "Drunk" )) )
            end,
        }
        ...
        elseif self.idName == "stress" then self.texBG = self:getImageBG(self.isoPlayer, MoodleType.ToIndex(MoodleType.FromString("Stress")) )
        elseif self.idName == "drunk" then self.texBG = self:getImageBG(self.isoPlayer, MoodleType.ToIndex(MoodleType.FromString("Drunk")) )
