...
MinimalDisplayBars.MOD_ID = "pz_minimaldisbplaybars_salacious"
...
local DEFAULT_SETTINGS = {
    ...
    ["hunger"] = {
        ["x"] = (Blood == nil) and 85 or 97, --85 + 12
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
    ...
    ["thirst"] = {
        ["x"] = ((Blood == nil) and 94 or 106), --97 + (9 * 1),
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
    ...
    ["endurance"] = {
        ["x"] = ((Blood == nil) and 85 or 97) + (9 * 2), --97 + (9 * 2)
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
    ...
    ["fatigue"] = {
        ["x"] = ((Blood == nil) and 85 or 97) + (9 * 3), --97 + (9 * 3)
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
    ...
    ["boredomlevel"] = {
        ["x"] = ((Blood == nil) and 85 or 97) + (9 * 4), --97 + (9 * 4)
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
    ...
    ["unhappynesslevel"] = {
        ["x"] = ((Blood == nil) and 85 or 97) + (9 * 5), --97 + (9 * 5)
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
    ...
    ["temperature"] = {
        ["x"] = ((Blood == nil) and 85 or 97) + (9 * 6), --97 + (9 * 6)
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
    ...
    ["calorie"] = {
        ["x"] = ((Blood == nil) and 85 or 97) + (9 * 7), --97 + (9 * 7)
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
    ...
    ["stress"] = {
        ["x"] = ((Blood == nil) and 85 or 97) + (9 * 8), --97 + (9 * 8)
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
    ...
    ["stoned"] = {
        ["x"] = ((Blood == nil) and 85 or 97) + (9 * 9), --97 + (9 * 9)
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
    ...
    ["drunkenness"] = {
        ["x"] = ((Blood == nil) and 85 or 97) + (9 * 10), --97 + (9 * 10)
        ["y"] = 30,
        ["width"] = 9,
        ["height"] = 150,
        ["l"] = 2,
...
local function onPlayerUpdateCheckBodyDamage(isoPlayer)
    ...
    for i=0, size do
        ...
        -- Salacious Added Immersive Medicine Support
        local blood = 5000;
        if not Blood == nil then
          blood = Survivor:getBlood():getVolume();
        end
...
-- Stoned Functions
local maxBeta = 6590  -- 3700 calories
local minBeta = -1  -- -2200 calories
local function calcStoned(value)
    return (value - minBeta) / (maxBeta- minBeta)
end
local function getStoned(isoPlayer, useRealValue)
    if useRealValue then
        return isoPlayer:getBetaEffect()
    else
        if isoPlayer:isDead() then
            return -1
        else
            return calcStoned( isoPlayer:getBetaEffect() )
        end
    end
end

local function getColorStoned(isoPlayer)
    local stonedRatio = isoPlayer:getModData().stonedamt
 --   print(stonedRatio)

    local color = MinimalDisplayBars.configTables[isoPlayer:getPlayerNum() + 1]["stoned"]["color"]
  if stonedRatio == 1 then
        color = { red = 81 / 255,
                    green = 255 / 255,
                    blue = 0 / 255,
                    alpha = 0.75 }
   elseif stonedRatio == 2 then
        color = { red = 65 / 255,
                    green = 205 / 255,
                    blue = 0 / 255,
                    alpha = 0.75 }
    elseif stonedRatio == 3 then
        color = { red = 58 / 255,
                    green = 182 / 255,
                    blue = 0 / 255,
                    alpha = 0.75 }
    elseif stonedRatio == 4 then
        color = { red = 46 / 255,
                    green = 146 / 255,
                    blue = 0 / 255,
                    alpha = 0.75 }
    elseif stonedRatio == 0 then
        color = { red = 200 / 255,
                    green = 7 / 255,
                    blue = 4 / 255,
                    alpha = 0.75 }
...
-- Drunkenness Functions
local function calcDrunkenness(value)
    return value / 100
end
local function getDrunkenness(isoPlayer, useRealValue)
    if useRealValue then
        return isoPlayer:getStats():getDrunkenness()
    else
        if isoPlayer:isDead() then
            return -1
        else
            return calcDrunkenness( isoPlayer:getStats():getDrunkenness() )
        end
    end
end

local function getColorDrunkenness(isoPlayer)
    local color
    color = MinimalDisplayBars.configTables[isoPlayer:getPlayerNum() + 1]["drunkenness"]["color"]
    return color
end
...
-- Blood Functions
local maxBlood = 5000
local function calcBlood(value)
    return value / maxBlood
end
local function getBlood(isoPlayer, useRealValue)
    local blood = 5000;
    if Blood == nil then return -1; end
    if Survivor == nil then return -1; end
    blood = Survivor:getBlood():getVolume() or Blood.maxVolume;
    if useRealValue then
        return blood
    else
        if isoPlayer:isDead() then
            ...
            return calcBlood( blood )
        end
    end
end
local function getColorBlood(isoPlayer)
    local color
    color = MinimalDisplayBars.configTables[isoPlayer:getPlayerNum() + 1]["blood"]["color"]
    return color
end
--============================
...
local function getMoodletThresholdTables()
    local t = {
        ...
        ["stress"] = {
            [1] = calcStress(0.25), -- 0.25 / 1.00
            [2] = calcStress(0.50),
            [3] = calcStress(0.75),
            [4] = calcStress(0.90),
        },
        ["drunkenness"] = {
            [1] = calcDrunkenness(10),
            [2] = calcDrunkenness(30),
            [3] = calcDrunkenness(50),
            [4] = calcDrunkenness(70),
        },
    }
...
local function createUiFor(playerIndex, isoPlayer)
    ...
    local bar12 = ISGenericMiniDisplayBar:new(
        ...
        nil)
    bar12:initialise()
    bar12:addToUIManager()    -- Add all valid display bars to a Global varible to be shared.

    local idName13 = "drunkenness"
    local bar13 = ISGenericMiniDisplayBar:new(
        ...
        nil,
        getDrunkenness,
        getColorDrunkenness, true,
        moodletThresholdTables[idName13])
    bar13:initialise()
    bar13:addToUIManager()    -- Add all valid display bars to a Global varible to be shared.

    local idName14 = "blood"
    local bar14 = ISGenericMiniDisplayBar:new(
        ...
        if not Blood == nil then
            bar14:initialise()
            bar14:addToUIManager()    -- Add all valid display bars to a Global varible to be shared.
        end
